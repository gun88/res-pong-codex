...
class Res_Pong_Admin_Frontend {
    ...
    public function render_user_detail() {
        ...
        echo '<p style=" margin-bottom: 0;"><textarea id="rp-invite-text" rows="5" class="large-text" style="max-width:600px;">' . esc_textarea($config['invitation_text']) . '</textarea></p>';
        ...
        echo '<p style=" margin-bottom: 0;"><textarea id="rp-reset-text" rows="5" class="large-text" style="max-width:600px;">' . esc_textarea($config['reset_password_text']) . '</textarea></p>';
